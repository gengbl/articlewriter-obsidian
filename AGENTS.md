...
| 你要做的事 | 加载文件 | 覆盖范围 |
| --- | --- | --- |
| 判断项目定位 / 功能边界 / 术语 | [agents/scope.md](./agents/scope.md) | 项目概述与范围、设计决策、明确不做清单、「小说」术语约定 |
...
| work_dir 初始化 / 切换小说相关逻辑 | [agents/workdir-behavior.md](./agents/workdir-behavior.md) | 工作目录初始化与切换小说的等价语义，lastStory 记忆规则 |
