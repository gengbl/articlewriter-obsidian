...
- GitHub 镜像 Release 自动化：向 `gengbl/articlewriter-obsidian` 推送新标签即触发 `.github/workflows/release.yml`（CI 从源码重建 + attestation 签名 + 自动创建/更新 Release，无需手动传附件）；细节与手动回落方案见 RELEASE.md「GitHub 镜像 Release」节
